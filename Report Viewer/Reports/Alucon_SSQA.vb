...
Public Class Alucon_SSQA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Report_Viewer.Alucon_SSQA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DocnoStarting() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DocnoEnding() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAlucon_SSQA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Alucon_SSQA = New Alucon_SSQA()
        rpt.Site = Me.Site
        Return rpt
    End Function
